...
/*   Updated: 2017/01/27 09:24:28 by qle-guen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** window
*/
double				w3d_window_fps(t_window *window, t_u64 start, t_u64 end);
void				w3d_window_draw(t_window *window, t_u32 *rays, t_u32 *ray_colors);
